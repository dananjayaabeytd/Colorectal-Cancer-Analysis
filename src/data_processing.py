...
class DataProcessing:
    ...
    # Initialize paths and preprocessing objects
    ...
    def preprocess_data(self):  
        try:
            ...
            logger.info("Data Separation Step Completed.")
            ...
            logger.info("Encoding of Categorical Features Completed.")

        except Exception as e:
            logger.error(f"Error occurred while preprocess data {e}")
    ...
    def feature_selection(self):
        try:
            ...
            logger.error(f"Error occurred while feature selection {e}")
    ...
    def split_and_scale_data(self):
        try:
            ...
            logger.error(f"Error occurred while splitting and scaling data {e}")
